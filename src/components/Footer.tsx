...
const footerLinks: Record<string, string[]> = {
  ...
  Developer: ["Docs", "API", "VS Code Extension", "GitHub"],
  Company: ["About", "Blog", "Discord", "Twitter"],
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4 group">
              ...
              <span className="text-xl font-bold text-white">Chorus</span>
            </Link>
            <p className="text-sm text-gray-500 mb-6 max-w-xs leading-relaxed">
              Your always-on AI development team. Build more, context-switch less.
            </p>
            {/* Social icons */}
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-600">
            © {new Date().getFullYear()} Chorus. All rights reserved.
          </p>
          <p className="text-sm text-gray-600">
